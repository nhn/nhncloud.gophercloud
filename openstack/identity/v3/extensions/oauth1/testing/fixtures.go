...
import (
	...
	"github.com/nhn/nhncloud.gophercloud/openstack/identity/v3/extensions/oauth1"
	tokens "github.com/nhn/nhncloud.gophercloud/openstack/identity/v3/tokens/testing"
